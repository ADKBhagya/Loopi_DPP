...
function SecurityExplorer({ onClose }: any) {
      ...
      <div className="fixed right-0 top-0 h-full w-[420px] bg-white shadow-2xl z-50 flex flex-col">
        ...
        <div className="p-5 border-b flex justify-between items-start">
          ...
          <div className="flex items-start gap-3">
            ...
            {/* ICON */}
            <div className="w-9 h-9 bg-red-100 text-red-500 rounded-xl flex items-center justify-center">
              <SecurityOutlinedIcon fontSize="small" />
            </div>

            {/* TEXT */}
            <div>
              <p className="text-sm font-semibold">Security Explorer</p>
              <p className="text-xs text-gray-400">
                Live audit trail — all system events
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-black transition"
            >
              <CloseOutlinedIcon fontSize="small" />
            </button>
        ...
        {/* STATS */}
        <div className="grid grid-cols-3 text-center border-b text-xs font-semibold">
          <div className="py-4 bg-red-50">
            <p className="text-lg text-red-500">3</p>
            <p className="text-gray-400">HIGH</p>
          </div>
          <div className="py-4 bg-yellow-50">
            <p className="text-lg text-yellow-500">3</p>
            <p className="text-gray-400">MEDIUM</p>
          </div>
          <div className="py-4 bg-blue-50">
            <p className="text-lg text-blue-500">4</p>
        ...
        <div className="p-4 border-b space-y-3">
          <input
            ...
            className="w-full h-10 px-3 rounded-lg border text-sm outline-none focus:border-[#1B5E20]"
          />
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3 space-y-4">
          {filtered.map((e, i) => (
            <ExplorerItem key={i} {...e} />
          ))}
        </div>

        {/* FOOTER */}
        <div className="p-4 border-t text-xs flex justify-between items-center text-gray-500">
...
function ExplorerItem({
  ...
  const badge: any = {
    ...
    MED: "bg-yellow-100 text-yellow-600",
  ...
  return (
    <div className="flex gap-3">
      ...
      {/* LEFT BAR */}
      <div className={`w-[3px] h-14 rounded ${colors[color]}`} />
      ...
      <div className="flex-1 space-y-1">
        ...
        <div className="flex items-center gap-2">
          <span className={`px-2 py-0.5 rounded text-[10px] ${badge[level]}`}>
            {level}
          </span>
